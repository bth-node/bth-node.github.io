...
För kursmoment 01, 02 och 03 kan du själv köra testerna:
```js
npm run test // kmom01-03
npm run test:kmom01 // kmom01
npm run test:kmom02 // kmom02
npm run test:kmom03 // kmom03
```
...
Du hittar information om hur man går tillväga i ["Gör en PR"](../gor-en-pr). Notera att artikeln visar hur man gör i kursen "Webtec". Det är samma förfarande här och notera även att man inte behöver länka till GitHub Pages då det inte används här.
