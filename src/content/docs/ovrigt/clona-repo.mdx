...
git@github.com:bth-node/node-mosstud.git
```
...
git clone git@github.com:bth-node/node-mosstud.git
```
...
git clone git@github.com:bth-node/node-mosstud.git node-mosstud_backup
```

I mitt fall så kommer repot att klonas och sparas som `node-mosstud_backup`.
